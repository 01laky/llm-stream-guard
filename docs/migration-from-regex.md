...
**Status:** 0.4.0 — upgrade path from ad-hoc filters to llm-stream-guard.
...
**To:** CI runs `validate` + `scan --json` on fixtures and captured streams (see cookbook §11). Full GitHub Action package → **0.5.0**.

See [integration cookbook](./integration-cookbook.md) and [examples/README.md](../examples/README.md).
